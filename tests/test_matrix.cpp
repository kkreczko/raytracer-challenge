...
TEST(Matrix, canInvertTrue) {
    ...
    EXPECT_EQ(determinant, -2120);
    EXPECT_TRUE(A.canInvert(determinant));
}
...
TEST(Matrix, canInvertFalse) {
    ...
    EXPECT_FALSE(A.canInvert(determinant));
}
...
TEST(Matrix, inverseSecond) {
    Matrix A = Matrix(4, 4,
                      std::vector<double>({8, -5, 9, 2, 7, 5, 6, 1, -6, 0, 9, 6,
                                           -3, 0, -9, -4}));
    Matrix B = A.inverse();
    Matrix expected =
        Matrix(4, 4,
               std::vector<double>({-0.15385, -0.15385, -0.28205, -0.53846,
...
TEST(Matrix, inverseThird) {
    Matrix A = Matrix(4, 4,
                      std::vector<double>({9, 3, 0, 9, -5, -2, -6, -3, -4, 9, 6,
                                           4, -7, 6, 6, 2}));
    Matrix B = A.inverse();
    Matrix expected =
        Matrix(4, 4,
               std::vector<double>({-0.04074, -0.07778, 0.14444, -0.22222,
...
TEST(Matrix, multiplyByInverse) {
    Matrix A = Matrix(4, 4,
                      std::vector<double>({3, -9, 7, 3, 3, -8, 2, -9, -4, 4, 4,
                                           1, -6, 5, -1, 1}));
    Matrix B = Matrix(4, 4,
                      std::vector<double>(
                          {8, 2, 2, 2, 3, -1, 7, 0, 5, 4, 6, -2, 0, 5, 0, 5}));
    Matrix C = A * B;
